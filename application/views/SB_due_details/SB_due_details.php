                ...
                <div class="col-lg-5">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form method="post" class="form-horizontal" id="agentDetails" action="<?=site_url('Admin/add_new_SB_due')?>" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Policy Number</label>
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="SB_Due_policy_number">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Cilent Code</label>
                                    <div class="col-sm-7">
                                        <select class="select2_demo_3 form-control" name="SB_Due_client_id">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <span class="add_SBI pull-right" style="color:#67C6F1; font-size: 08px;"><i class="fa fa-plus fa-2x" aria-hidden="true"><u style="margin-left: 5px;"> <b>New</b></u></i></span>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    <div class="col-lg-6" style="text-align:right;">
                                        <button class="btn btn-primary" type="submit">Add SB Due</button>
                                    </div>
                                    <div class="col-lg-6">
