...
<?php 
$path = base_url('assets')."/img/background1.jpeg";
$path1 = base_url('assets')."/img/logo1.jpg";
...
<body class="gray-bg" style="background: url('<?php echo $path;?>') no-repeat center center fixed;background-size: cover;" >
    <div style=" padding-top: 10%;">
        ...
        <img src="<?php echo $path1; ?>" style="height: 80px;">
            <h2 style="color: #000;padding-bottom: 20px;"><b>Welcome To LIC</b></h2>
        ...
        <center>
            <!-- <div class="col-sm-4"> -->
                <div class="">
                    ...
                    <a href="http://www.syntech.co.in" target="_blank"> 
                    <img src="<?=base_url()?>assets/img/syntech1.png" style="height:50px;">
                    </a>
