                        ...
                        <div class="ibox-content">
                            <form method="post" class="form-horizontal" id="agentDetails" action="<?=site_url('Admin/add_new_agent')?>" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="agent_name" onkeyup="caps(this)">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Agent Short Code</label>
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="agent_short_code" onkeyup="caps(this)">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Agent Code</label>
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="agent_code" onkeyup="caps(this)">
                                    </div>
                                </div>
                        ...
                        <div class="modal-body">
                            <form method="post" class="form-horizontal" id="update_agentDetails" action="<?=site_url('Admin/edit_agent')?>" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Agent Name</label>
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control agent_name_edit" name="agent_name" onkeyup="caps(this)">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Agent Short Code</label>
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control agent_short_code_edit" name="agent_short_code" onkeyup="caps(this)" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                <label class="col-sm-3 control-label">Agent Code</label>
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control agent_code_edit" name="agent_code" onkeyup="caps(this)"> 
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
